                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="max-w-2xl w-full">
                        <div className="flex items-center w-full mb-8 mt-4">
                            ...
                            {/* Right line */}
                            <div className="flex-1 h-px bg-linear-to-r from-gray-800 dark:from-gray-300 to-transparent" />

                        </div>
                        <div className="flex items-center justify-center">
                             <h2 className="text-4xl font-bold text-black dark:text-white">I like building things</h2>
                        </div>
                                    ...
                                    return (
                                        ...
                                        >
                                            <div className="relative w-12 shrink-0 flex flex-col items-center">
                                                {!isFirst && (
                                                    <div className="absolute left-1/2 top-0 h-6 w-px -translate-x-1/2 bg-gray-200 dark:bg-gray-700" />
                                                )}

                                                <div className="relative z-10 size-12 shrink-0 aspect-square rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 flex items-center justify-center">
                                                    <img
                                                        src={item.logo}
                                                        alt={item.title}
                                                ...
                                                {!isLast && (
                                                    <div className="w-px flex-1 bg-gray-200 dark:bg-gray-700 mt-0" />
                                                )}
                                            </div>

                                            <div className={`pt-1 flex-1 ${isLast ? "" : "pb-14"}`}>
                                                <p className="text-[13px] font-thin text-gray-500 dark:text-gray-400">{item.date}</p>
